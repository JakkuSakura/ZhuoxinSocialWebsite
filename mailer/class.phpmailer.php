<?php
/**
 * Modified by Qiu Jiangkun
 * changes:
 * revert all the echo into sendmsg()
 */
 ...
 /**
  ...
  private function AddAnAddress($kind, $address, $name = '') {
    if (!preg_match('/^(to|cc|bcc|ReplyTo)$/', $kind)) {
      sendmsg("failed", 'Invalid recipient array: ' . $kind);
      return false;
    }
    ...
    if (!self::ValidateAddress($address)) {
      ...
      sendmsg("failed", $this->Lang('invalid_address').': '.$address);
      return false;
    }
    if ($kind != 'ReplyTo') {

...
<div style="width:800px; margin:auto;border:1px #bbb solid;border-radius:5px; box-shadow:1px 1px 10px rgba(0, 0, 0, 0.25); padding:20px; text-align:left;">
    ...
    <div style="border-radius:5px; background-color:#f5f5f5; padding:10px; font-size:32px; margin-bottom:10px;">
        上传头像自定义裁切
    </div>
    ...
    <table style=" width:100%; border:#eee 1px solid;">
        <tr>
            ...
            <td>
                <div id="my_avatar"><img
                            src="avatars/<?php echo isset($_COOKIE['avatar']) ? $_COOKIE['avatar'] : 'default.png'; ?>"/>
                </div>
            </td>
        </tr>
        ...
        <tr>
            <td>&nbsp;</td>
            <td><input type="button" id="btn_save_crop" value="保存" style="padding:2px 10px;"
                       onClick="javascript:saveCropAvatar();"/></td>
        </tr>
    </table>
